...
func TestH1(t *testing.T) {
	...
	var tests = map[string]struct {
		...
		"nil": {
			m:        nil,
			expected: "97585260015070069107900449897303387067318390645320999614070464647889576118428",
		},
		"empty": {
			m:        nil,
			expected: "97585260015070069107900449897303387067318390645320999614070464647889576118428",
		...
		"non-empty": {
			m:        []byte("hello_world"),
			expected: "79421398523000937625369375535573689735555600905496788844188759497898723906868",
		},
	}
